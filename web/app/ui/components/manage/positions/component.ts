...
export default class HumanPositionsComponent extends Component<HumanPositionsArgs> {
	...
	addTask = task(function* (this: HumanPositionsComponent, model: Changeset<Position>) {
		if (!model.isDirty) {
			return;
		}
	...
	editTask = task(function* (this: HumanPositionsComponent, model: Changeset<Position>) {
		if (!model.isDirty) {
			return;
		}
	...
	removeTask = task(function* (this: HumanPositionsComponent, id: string) {
