...
export default class ManageInstrumentsComponent extends Component<ManageInstrumentsArgs> {
	...
	addTask = task(function* (this: ManageInstrumentsComponent, model: Changeset<Instrument>) {
		if (!model.isDirty) {
			return;
		}
	...
	editTask = task(function* (this: ManageInstrumentsComponent, model: Changeset<Instrument>) {
		if (!model.isDirty) {
			return;
		}
	...
	removeTask = task(function* (this: ManageInstrumentsComponent, id: string) {
